    ...
    <Backdrop onClick={handleClose}>
      {type === "dropIn" && (
        <motion.div
          ...
          className="rounded-xl flex flex-col justify-center bg-white dark:bg-[#1D2226] w-full max-w-lg
        md:-mt-96 mx-6"
          variants={dropIn}
          initial="hidden"
          animate="visible"
      ...
      {type === "gifYouUp" && (
        ...
        >
          <motion.img
            ...
            src={post.photoUrl}
            className="object-contain max-h-[80vh] w-full max-w-3xl rounded-l-lg bg-[white]/60"
          />
